...
export function Footer() {
  return (
    <SectionContainer className="border-t border-black/10 bg-[color:var(--color-surface)] py-12 sm:py-14 lg:py-16">
      <div className="flex flex-col gap-10">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="h-12 w-12 rounded-full bg-[color:var(--color-ink)]" />
          </div>
          <span className="display-font text-3xl uppercase text-[color:var(--color-ink)] sm:text-4xl">
            PrimalTraining
          </span>
        </div>
